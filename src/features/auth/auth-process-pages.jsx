...
export function EmailVerificationPage() {
  ...
  return (
    <AuthProcessShell eyebrow="EMAIL VERIFICATION" title="Enter your verification code" description="Confirm your email to activate your AjoPay account and wallet." illustration="otp">
      ...
      <div className="auth-process__resend">
        <span>Didn’t receive the email?</span>
        <button type="button" onClick={resend} disabled={busy}>Send a new code</button>
      </div>
    ...
    <AuthProcessShell {...content}>
      ...
      {step === "OTP" && (
        <>
          ...
          <div className="auth-process__resend"><span>Code missing or expired?</span><button type="button" onClick={resend} disabled={busy}>Resend code</button></div>
        </>
      )}
