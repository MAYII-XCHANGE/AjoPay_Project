...
const AdminOverviewPage = lazyNamed(() => import("../features/admin/admin-overview-page"), "AdminOverviewPage");
const AdminUsersPage = lazyNamed(() => import("../features/admin/admin-users-page"), "AdminUsersPage");
const AdminAjosPage = lazyNamed(() => import("../features/admin/admin-ajos-page"), "AdminAjosPage");
const AdminSettingsPage = lazyNamed(() => import("../features/admin/admin-settings-page"), "AdminSettingsPage");
